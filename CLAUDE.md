...
- İmza şeması: SPHINCS- / SLH-DSA-SHA2-128-24 (Consigny'nin SPHINCS- makalesindeki varyant ismi, resmi FIPS 205 seti değil) — ~142K gas (Kaynağın kendi ölçümü — bizim Foundry ortamımızda henüz doğrulanmadı. Sprint 0'da doğrulanana kadar kesinleşmiş sayılmayacak.)
